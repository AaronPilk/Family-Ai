...
export type MemberId =
  | 'me' | 'mom' | 'dad' | 'mike' | 'grace' | 'jake' | 'cole';
...
export const MEMBERS: Record<MemberId, Member> = {
  ...
  mike:  { id: 'mike',  name: 'Mike',   relationship: 'Brother',       initials: 'M', color: '#3B7BC9', age: 38 },
  grace: { id: 'grace', name: 'Grace',  relationship: 'Grandma',       initials: 'G', color: '#8C5BB1', age: 84 },
  jake:  { id: 'jake',  name: 'Jake',   relationship: 'Stepbrother',   initials: 'J', color: '#D49B3E', age: 33 },
  cole:  { id: 'cole',  name: 'Cole',   relationship: 'Stepbrother',   initials: 'C', color: '#5C9E8C', age: 29 },
};
...
export function membersOf(branchId: BranchId): Member[] {
  return BRANCHES[branchId].memberIds
    .filter((id) => id !== 'me')
    .map((id) => MEMBERS[id]);
}
...
export const INBOX: InboxQuestion[] = [
  { id: 'q1', branchId: 'pilks',      fromId: 'mom',   body: 'What was the name of the cat we had when you were 6? Mike says Whiskers, I say Tigger.', whenAgo: '1h ago' },
  { id: 'q2', branchId: 'pilks',      fromId: 'grace', body: 'Tell me what your kids are into right now. I want to know.', whenAgo: 'yesterday' },
  { id: 'q3', branchId: 'pilks',      fromId: 'dad',   body: 'What\'s the best advice I ever gave you that actually worked?', whenAgo: '3d ago' },
  { id: 'q4', branchId: 'stepfamily', fromId: 'jake',  body: 'What was your favorite day from any of our summers up at the lake?', whenAgo: '2d ago' },
];
...
export const PHOTO_BOOKS: PhotoBook[] = [
  { id: 'pb1', title: 'Grandma\'s wedding album', ownerId: 'grace', pageCount: 84,  status: 'ready',      coverTint: '#D8C7CC', yearRange: '1962' },
  { id: 'pb2', title: 'Family vacations 1988–1995', ownerId: 'mom', pageCount: 142, status: 'processing', coverTint: '#E8D5C4', yearRange: '1988–95' },
];
...
export const MOMENTS: FamilyMoment[] = [
  {
    ...
    locationPoll: [
      { id: 'l1', label: 'Lakefront cabin · 4BR', subtitle: '$420/night · sleeps 8 · pier',          tint: '#9BC7E4', votes: ['me', 'mom', 'mike'] },
      { id: 'l2', label: 'Tahoe vista lodge',     subtitle: '$340/night · sleeps 10 · hot tub',     tint: '#C3D8B5', votes: ['dad', 'grace'] },
      { id: 'l3', label: 'Cozy A-frame',          subtitle: '$280/night · sleeps 6 · walk to town', tint: '#E8C8B0', votes: [] },
    ],
    packingList: [
    ...
    activity: [
      { id: 'a1', authorId: 'mom',  body: 'Found that lakefront cabin again — same one from 2014!', whenAgo: '2d ago' },
      { id: 'a2', authorId: 'mike', body: 'I can fly in Friday night.',                              whenAgo: '2d ago' },
      { id: 'a3', authorId: 'dad',  body: 'Bringing the fishing gear. Pier is the dream.',          whenAgo: '1d ago' },
      { id: 'a4', authorId: 'me',   body: 'I\'ll grab disposable cameras so we have prints after.',  whenAgo: '4h ago' },
    ],
  },
  {
    id: 'thanksgiving',
    ...
    participantIds: ['me', 'mom', 'dad', 'mike', 'grace'],
    activity: [
      { id: 'b1', authorId: 'grace', body: 'I\'ll do the turkey. Everyone else picks a side.', whenAgo: '1w ago' },
    ],
  },
];
...
export const MEMORIES_WITH: Record<MemberId, number> = {
  me: 0, mom: 62, dad: 18, mike: 27, grace: 41, jake: 9, cole: 6,
};
